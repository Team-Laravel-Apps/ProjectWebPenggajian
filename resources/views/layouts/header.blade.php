<nav class="main-header navbar navbar-expand bg-dark navbar-warning border-bottom">
    <ul class="navbar-nav">
        <li class="nav-item">
            ...
            <ul class="nav navbar-nav nav-link">
                <li class="dropdown user user-menu">
                    <a href="#" data-toggle="dropdown">
                        ...
                        <img src="{{ asset(Auth::user()->staff->photo ?? 'img/user.jpg') }}"
                            class="img-circle elevation-2"
                            style="width: 30px; height: 30px;margin-top: -8px;margin-right: -5px;border-radius: 100%;">
                    </a>
                    <ul class="dropdown-menu pb-0" style="min-width:250px;">
                        <li class="user-header text-center">
                            ...
                            <img src="{{ asset(Auth::user()->staff->photo ?? 'img/user.jpg') }}"
                                class="img-size-50 img-circle elevation-2" style="width: 50px; height: 50px;">
                            <p>
                                <br>
